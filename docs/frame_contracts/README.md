...
| [process](process.md) | 进程 | `REQUEST_PROCESS_CONTROL`、`RTN_PROCESS_STATUS`、`SET/RTN_PROCESS_CONFIG`、`SHUTDOWN` | `libs/platform/.../process.h` |
...
| [account-status](account-status.md) | 账户登录状态 | `ACCOUNT_STATUS`/`TD_QUERY_ACCOUNT_STATUS` | `libs/strategy_api/include/dztrader/struct.h`、`libs/core/.../core_struct.h` |
